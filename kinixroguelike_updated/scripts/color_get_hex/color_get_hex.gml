...
function color_get_hex(argument0) {

	/*
	Returns a hex color code as a string from an RGB color.

	Note that a leading # is returned along with the color string. If any unacceptable 
	input is made, the script will return "#FFFFFF".

	argument0 = rgb color (color)
	...
	*/
	...
	if (is_string(argument0)) { //Ensure input is a color code
	   return "#FFFFFF";
	}
