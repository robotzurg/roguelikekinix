...
#region Pistol Map
	...
	ds_map_add(global.pistolmap,"Sprite",spr_gun); //Sprite of the Gun
	...
	ds_map_add(global.pistolmap,"Bullet Sprite",spr_bullet); //Self Explanatory.
...
#region Homing Staff Map
	...
	ds_map_add(global.homingstaffmap,"Sprite",spr_homingWand); //Sprite of the Gun
	...
	ds_map_add(global.homingstaffmap,"Bullet Sprite",spr_homingstaffbullet); //Self Explanatory.
...
#region Sniper Wand Map
	...
	ds_map_add(global.sniperwandmap,"Sprite",spr_sniperWand); //Sprite of the Gun
	...
	ds_map_add(global.sniperwandmap,"Bullet Sprite",spr_SniperWandBullet); //Self Explanatory.
...
#region Golfball Map (used with Golf Club melee weapon)
	...
	ds_map_add(global.golfballmap,"Sprite",spr_golfclub); //Sprite of the Gun
	...
	ds_map_add(global.golfballmap,"Bullet Sprite",spr_golfball); //Self Explanatory.
...
#region Sword Map
	...
	ds_map_add(global.swordmap,"Sprite",spr_sword); //Sprite of the Melee
	...
	ds_map_add(global.swordmap,"Slash Sprite",spr_swordswing); //Sprite of the slash
...
#region Golf Club Map
	...
	ds_map_add(global.golfclubmap,"Sprite",spr_golfclub); //Sprite of the Melee
	...
	ds_map_add(global.golfclubmap,"Slash Sprite",spr_golfhit); //Sprite of the slash
...
#region Player Map
	...
	ds_map_add(global.playermap,"Sprite",spr_player); //Sprite of the Character
...
#region Bat Map
	...
	ds_map_add(global.batmap,"Sprite",spr_bat);
...
#region Ram Map
	...
	ds_map_add(global.rammap,"Sprite",spr_ram);
...
function init_rooms() {
	global.valleyareas = ds_list_create();
	global.valleytiles = array_create(3);
